      ...
      <ScrollReveal>
        <section className="max-w-3xl mx-auto px-6 py-8">
          ...
          <div className="prose prose-lg text-foreground/80 space-y-4">
            ...
            <p>
              Nach Stationen als CEO eines Online-Bewertungsportals (Ausgezeichnet.org) widmet sich Thomas heute vollständig dem Ausbau des Jobsingles-Netzwerks — mit dem Ziel, dass jeder Mensch im Schichtdienst einen Partner finden kann, der das Leben wirklich versteht.
            </p>
          </div>
        </section>
      </ScrollReveal>
